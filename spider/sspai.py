...
def main_info(page):
    base = "https://beta.sspai.com/api/v1/article/index/page/get?limit=10&offset={}".format(page)
    headers = {
    ...
    try:
        ...
        if res.status_code in (200, 304):
            ...
            print('Something wrong has happended, status code is: %s' %res.status_code)
...
def concat_data(page):
    ...
    while True:
        if page <= 12210:
            ...
            print(r'Get the data of page[%s] ...' % page)
            page += 1
